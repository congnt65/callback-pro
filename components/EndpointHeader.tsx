            ...
            <div className="flex items-center gap-2 mb-2">
                ...
                >
                    ...
                    <button
                        ...
                        className="text-xs shrink-0 hover:opacity-80 transition-colors"
                        title="Copy URL"
                    >
                        {copied ? (
                            <svg
                ...
                <button
                    ...
                    className="text-xs px-2 py-1 rounded border shrink-0 hover:text-white hover:border-gray-500 transition-colors"
                    title="Generate a new endpoint"
                >
                    + New
                </button>
            </div>
